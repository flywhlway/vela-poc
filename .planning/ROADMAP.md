...
- [x] **Phase 3: 编排层逻辑止血** - 消除首轮误停 / JSON 解析 / 截断 / verifier 判据 / 技能锁死等逻辑必然缺陷 (completed 2026-08-01)
...
- [x] 02-02-PLAN.md — config_hash 扩展与断代映射表（METR-03）
- [x] 02-03-PLAN.md — LLM 磁盘缓存 + TokenLedger 成本归集（METR-06/PERF-02）
...
- [x] 03-01-PLAN.md — Wave 0 单测骨架（ORCH-01..10 xfail 契约）

**Wave 1** *(blocked on Wave 0)*

- [x] 03-02-PLAN.md — LLM 输出契约：_llm_json / 禁跨段解析 / max_tokens=2048 / truncation（ORCH-03/04）
...
- [x] 03-04-PLAN.md — 首轮 stop 守卫 + PLANNER 规则 5 重写（ORCH-01/02）
...
- [x] 03-07-PLAN.md — 回归门（make test + mock eval 回归 0）并勾选 ORCH-01..10
...
| 3. 编排层逻辑止血 | 7/7 | Complete   | 2026-08-01 |
