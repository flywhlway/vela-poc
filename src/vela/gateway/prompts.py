...
status 枚举：supported|partial|weak|unsupported。
变体（Supported / partially_supported / partially-supported / supported with caveats 等）会被归一化；
partial 表示部分支撑（≥2 条可推进流程）；weak 不计入 partial。
